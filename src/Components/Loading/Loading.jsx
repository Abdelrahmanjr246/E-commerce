    ...
    <div className={styles.loading}>
      <div className="preloader">
        ...
        <div className="preloader__text">
          <p className="preloader__msg text-darkPrimary"><span className='font-bold'>FreashCart</span> is loading...</p>
          <p className="preloader__msg preloader__msg--last text-red-600">This is taking long. Something’s wrong.</p>
        </div>
      </div>
    </div>
  )
